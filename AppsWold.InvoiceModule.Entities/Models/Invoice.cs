...
namespace AppsWorld.InvoiceModule.Entities
{
    ...
    public partial class Invoice : Entity
    {
        ...
        public Invoice()
        {
            ...
            //this.BeanEntity=new BeanEntity();
        }
        ...
        public Guid? SyncWFInvoiceId { get; set; }
        public string SyncWFInvoiceStatus { get; set; }
        public DateTime? SyncWFInvoiceDate { get; set; }
        public string SyncWFInvoiceRemarks { get; set; }
        ...
        public string PeppolStatusCode { get; set; }
        public string PeppolRemarks { get; set; }
