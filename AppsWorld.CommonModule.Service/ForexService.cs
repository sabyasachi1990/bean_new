...
namespace AppsWorld.CommonModule.Service
{
	...
	//{
	//	private readonly ICommonModuleRepositoryAsync<Forex> _forexRepository;
	//	private readonly IGSTSettingService _gstSettingService;
	//	private readonly IFinancialSettingService _financialSettingService;

	//	public ForexService(ICommonModuleRepositoryAsync<Forex> forexRepository, IGSTSettingService gstSettingService, IFinancialSettingService financialSettingService)
 ...
 //               forex.UnitPerUSD = forex.UnitPerCal.Value;
	//		return forex;
	//	}
