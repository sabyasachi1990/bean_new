...
{
    public class WithdrawalCreatedHandler:IDomainEventHandler<WithdrawalCreated>
    {
        ...
        public WithdrawalCreatedHandler()
        {
        ...
        public void When(WithdrawalCreated @event)
        {
            ...
            _eventStoreOperations.SaveEventToStream(@event, metaDataObj, environment + @event.WithdrawalModel.CompanyId + "-Withdrawal", typeof(WithdrawalCreated).Name);
        }
    }
}
