...
{
    public class DepositCreatedHandler:IDomainEventHandler<DepositCreated>
    {
        ...
        public void When(DepositCreated @event)
        {
            ...
            _eventStoreOperations.SaveEventToStream(@event, metaDataObj, environment + @event.DepositModel.CompanyId + "-Deposit", typeof(DepositCreated).Name);
        }
    }
}
