...
{
    public class CashPaymentCreatedHandler:IDomainEventHandler<CashPaymentCreated>
    {
        ...
        public CashPaymentCreatedHandler()
        {
        ...
        public void When(CashPaymentCreated @event)
        {
            ...
            _eventStoreOperations.SaveEventToStream(@event, metaDataObj, environment + @event.CashPaymentsModel.CompanyId + "-Cash Payments", typeof(CashPaymentCreated).Name);
        }
    }
}
