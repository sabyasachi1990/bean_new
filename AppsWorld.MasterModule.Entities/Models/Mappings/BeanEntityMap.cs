...
namespace AppsWorld.MasterModule.Entities.Models.Mappings
{
    public class BeanEntityMap : EntityTypeConfiguration<BeanEntity>
    {
        public BeanEntityMap()
        {
            ...
            this.Property(t => t.IsExternalData).HasColumnName("IsExternalData");
            ...
            this.Property(t => t.VenBal).HasColumnName("VenBal");
            ...
            this.Property(t => t.PrincipalActivities).HasColumnName("PrincipalActivities");
            // Relationships
            //this.HasOptional(t => t.AccountType)
            //    .WithMany(t => t.BeanEntities)
