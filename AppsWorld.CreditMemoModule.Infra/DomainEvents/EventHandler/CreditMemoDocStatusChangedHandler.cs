...
{
    public class CreditMemoDocStatusChangedHandler : IDomainEventHandler<CreditMemoDocStatusChanged>
    {
        ...
        public CreditMemoDocStatusChangedHandler()
        {
        ...
        public void When(CreditMemoDocStatusChanged @event)
        {
            ...
            _eventStoreOperations.SaveEventToStream(@event, metaDataObj, environment + @event.CreditMemoModel.CompanyId + "-CreditMemo", typeof(CreditMemoDocStatusChanged).Name);
        }
    }
}
