...
{
    public class MultiCurrencySettingCreatedHandler : IDomainEventHandler<MultiCurrencySettingCreated>
    {
        ...
        public MultiCurrencySettingCreatedHandler()
        {
        ...
        public void When(MultiCurrencySettingCreated @event)
        {
			...
			_eventStoreOperations.SaveEventToStream(@event, metaDataObj, environment + @event.MultiCurrencySetting.CompanyId + "-MultiCurrencySetting", typeof(MultiCurrencySettingCreated).Name);
        }
    }
}
