...
namespace AppsWorld.MasterModule.Infra
{
    ...
    using Domain.Events;
    public class TaxCodeCreateHandler : IDomainEventHandler<TaxCodeCreated>
    {
        ...
        public void When(TaxCodeCreated @event)
        {
            ...
            _eventStoreOperations.SaveEventToStream(@event, metaDataObj, environment+@event.TaxCode.CompanyId + "-TaxCode", typeof(TaxCodeCreated).Name);
        }
    }
}
