...
{
    public class FinancialSettingCreatedHandller : IDomainEventHandler<FinancialSettingCreated>
    {
        ...
        public FinancialSettingCreatedHandller()
        {
        ...
        public void When(FinancialSettingCreated @event)
        {
            ...
            object metaDataObj = new
            {
                ...
                Description = String.Format("An FinancialSetting is created by {0} on {1}",@event.FinancialSetting.UserCreated,@event.FinancialSetting.CreatedDate)
            };
			_eventStoreOperations.SaveEventToStream(@event, metaDataObj, environment + @event.FinancialSetting.CompanyId + "-FinancialSetting", typeof(FinancialSettingCreated).Name);
        }
    }
}
