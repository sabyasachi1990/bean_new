...
{
  public  class BeanEntityStatusChangedHandler:IDomainEventHandler<BeanEntityStatusChanged>
    {
      ...
      public BeanEntityStatusChangedHandler()
        {
        ...
        public void When(BeanEntityStatusChanged @event)
        {
			...
			_eventStoreOperations.SaveEventToStream(@event, metaDataObj, environment + @event.BeanEntity.CompanyId + "-BeanEntity", typeof(BeanEntityStatusChanged).Name);
        }
    }
}
