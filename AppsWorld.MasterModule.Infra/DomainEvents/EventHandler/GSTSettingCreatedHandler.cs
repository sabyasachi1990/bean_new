...
{
    public class GSTSettingCreatedHandler : IDomainEventHandler<GSTSettingCreated>
    {
        ...
        public GSTSettingCreatedHandler()
        {
        ...
        public void When(GSTSettingCreated @event)
        {
			...
			_eventStoreOperations.SaveEventToStream(@event, metaDataObj, environment + @event.GSTSetting.CompanyId + "-GSTSetting", typeof(GSTSettingCreated).Name);
        }
    }
}
