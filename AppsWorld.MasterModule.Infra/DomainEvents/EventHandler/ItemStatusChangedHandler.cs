...
{
  public  class ItemStatusChangedHandler:IDomainEventHandler<ItemStatusChanged>
  {
      ...
      public ItemStatusChangedHandler()
      {
      ...
      public void When(ItemStatusChanged @event)
      {
		...
		_eventStoreOperations.SaveEventToStream(@event, metaDataObj, environment + @event.Item.CompanyId + "-Item", typeof(ItemStatusChanged).Name);
        }
