...
{
    public class RevaluationCreatedHandler:IDomainEventHandler<RevaluationCreated>
    {
        ...
        public RevaluationCreatedHandler()
        {
        ...
        public void When(RevaluationCreated @event)
        {
            ...
            _eventStoreOperations.SaveEventToStream(@event, metaDataObj, environment + @event.RevaluationModel.CompanyId + "-Revaluation", typeof(RevaluationCreated).Name);
        }
    }
}
