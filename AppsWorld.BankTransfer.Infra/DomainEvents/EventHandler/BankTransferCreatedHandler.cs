...
{
    public class BankTransferCreatedHandler : IDomainEventHandler<BankTransferCreated>
    {
        ...
        public BankTransferCreatedHandler()
        {
        ...
        public void When(BankTransferCreated @event)
        {
            ...
            _eventStoreOperations.SaveEventToStream(@event, metaDataObj, environment + @event.BankTransferModel.CompanyId + "-Transfer", typeof(BankTransferCreated).Name);
        }
    }
}
