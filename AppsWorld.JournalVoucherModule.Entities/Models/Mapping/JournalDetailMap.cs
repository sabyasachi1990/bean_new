...
namespace AppsWorld.JournalVoucherModule.Entities.Models.Mapping
{
    public class JournalDetailMap : EntityTypeConfiguration<JournalDetail>
    {
        public JournalDetailMap()
        {
            ...
            this.Property(t => t.CorrAccountId).HasColumnName("CorrAccountId");
            ...
            this.Property(t => t.GSTTaxDebit).HasColumnName("GSTTaxDebit");
            this.Property(t => t.GSTTaxCredit).HasColumnName("GSTTaxCredit");
            // Relationships
