...
namespace AppsWorld.PaymentModule.Entities.Mapping
{
    public class PaymentMap : EntityTypeConfiguration<Payment>
    {
        public PaymentMap()
        {
            ...
            this.Property(t => t.ModeOfPayment).HasColumnName("ModeOfReceipt");
            ...
            this.Property(t => t.IsExchangeRateLabel).HasColumnName("IsExchangeRateLabel");
            ...
            //this.HasRequired(t => t.BenEntity)
            //    .WithMany(t => t.Payments)
