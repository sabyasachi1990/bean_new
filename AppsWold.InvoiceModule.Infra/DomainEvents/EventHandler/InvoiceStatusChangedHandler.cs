...
namespace AppsWorld.InvoiceModule.Infra
{
	...
	public class InvoiceStatusChangedHandler : IDomainEventHandler <InvoiceStatusChanged>
	{
		...
		public void When(InvoiceStatusChanged @event)
		{
			...
			_eventStoreOperations.SaveEventToStream(@event, metaDataObj, environment + @event.Invoice.CompanyId + "-Invoice", typeof(InvoiceStatusChanged).Name);
		}
