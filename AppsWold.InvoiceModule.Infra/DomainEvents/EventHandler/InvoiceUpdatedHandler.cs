...
namespace AppsWorld.InvoiceModule.Infra
{
    ...
    using Domain.Events;
    public class InvoiceUpdatedHandler : IDomainEventHandler<InvoiceUpdated>
    {
        ...
        public void When(InvoiceUpdated @event)
        {
            ...
            _eventStoreOperations.SaveEventToStream(@event, metaDataObj, environment + @event.Invoice.CompanyId + "-Invoice", typeof(InvoiceUpdated).Name);
        }
