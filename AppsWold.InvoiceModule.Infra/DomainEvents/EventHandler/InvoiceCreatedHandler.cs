...
{   
    ...
    using Domain.Events;
    public class InvoiceCreatedHandler : IDomainEventHandler<InvoiceCreated>
    {
        ...
        public void When(InvoiceCreated @event)
        {
			...
			_eventStoreOperations.SaveEventToStream(@event, metaDataObj, environment + @event.Invoice.CompanyId + "-Invoice", typeof(InvoiceCreated).Name);
        }
