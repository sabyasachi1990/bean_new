...
{
   public  class ClearingCreatedHandler:IDomainEventHandler<ClearingCreated>
    {
        ...
        public void When(ClearingCreated @event)
        {
            ...
            _eventStoreOperations.SaveEventToStream(@event, metaDataObj, environment + @event.ClearingModel.CompanyId + "-Clearing", typeof(ClearingCreated).Name);
        }
    }
}
