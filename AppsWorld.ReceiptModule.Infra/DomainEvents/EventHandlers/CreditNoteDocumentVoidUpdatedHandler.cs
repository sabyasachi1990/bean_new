...
{
    public class CreditNoteDocumentVoidUpdatedHandler:IDomainEventHandler<CreditNoteDocumentVoidUpdated>
    {
        ...
        public CreditNoteDocumentVoidUpdatedHandler()
        {
        ...
        public void When(CreditNoteDocumentVoidUpdated @event)
        {
            ...
            _eventStoreOperations.SaveEventToStream(@event, metaDataObj, environment + @event.ReceiptModel.CompanyId + "-CreditNoteDocument", typeof(CreditNoteDocumentVoidUpdated).Name);
        }
    }
}
