...
namespace AppsWorld.CreditMemoModule.Models
{
    public class CreditMemoModel
    {
        ...
        {
            this.CreditMemoApplicationModels = new List<CreditMemoApplicationModel>();
            //this.MemoApplicationModels = new List<MemoApplicationModel>();
        }
        ...
        public virtual ICollection<CreditMemoApplicationModel> CreditMemoApplicationModels { get; set; }
        //public virtual ICollection<GSTDetailModel> GSTDetailModels { get; set; }
        //public virtual ICollection<MemoApplicationModel> MemoApplicationModels { get; set; }
