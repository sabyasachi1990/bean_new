...
namespace WebApi.RedisCache.V2
{
    public class CacheOutputConfiguration
    {
        ...
        public IApiOutputCache GetCacheOutputProvider(HttpRequestMessage request)
        {
            ...
            var cacheOutputProvider = cacheFunc != null ? cacheFunc() : request.GetDependencyScope().GetService(typeof(IApiOutputCache)) as IApiOutputCache ?? new RedisCacheDefault();
