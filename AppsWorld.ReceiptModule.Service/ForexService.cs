...
namespace AppsWorld.ReceiptModule.Service
{
	...
	//{
	//	private readonly IReceiptModuleRepositoryAsync<Forex> _forexRepository;
	//	private readonly IGSTSettingService _gstSettingService;
	//	private readonly IFinancialSettingService _financialSettingService;

	//	public ForexService(IReceiptModuleRepositoryAsync<Forex> forexRepository, IGSTSettingService gstSettingService, IFinancialSettingService financialSettingService)
