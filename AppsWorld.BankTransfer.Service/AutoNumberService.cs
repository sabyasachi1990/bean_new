...
namespace AppsWorld.BankTransferModule.Service
{
    ...
    {
        private readonly IBankTransferModuleRepositoryAsync<AutoNumber> _autoNumberepository;
        private readonly IAutoNumberCompanyService _autoNumberCompanyService;
        public AutoNumberService(IBankTransferModuleRepositoryAsync<AutoNumber> autoNumberRepository, IAutoNumberCompanyService autoNumberCompanyService)
