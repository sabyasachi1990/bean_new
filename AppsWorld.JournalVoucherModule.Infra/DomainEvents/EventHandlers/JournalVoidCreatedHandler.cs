...
{
    public class JournalVoidCreatedHandler:IDomainEventHandler<JournalVoidCreated>
    {
        ...
        public JournalVoidCreatedHandler()
        {
        ...
        private string heading = "JournalVoid";
        private string moduleName = MenuConstants.MENU_BEAN;
        public void When(JournalVoidCreated @event)
        {
            ...
            _eventStoreOperations.SaveEventToStream(@event, metaDataObj, environment + @event.JournalModel.CompanyId + "-JournalVoid", typeof(JournalVoidCreated).Name);
        }
    }
}
