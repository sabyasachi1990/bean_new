...
{
    public class CashSaleUpdatedHandler : IDomainEventHandler<CashSaleUpdated>
    {
        ...
        public void When(CashSaleUpdated @event)
        {
            ...
            _eventStoreOperations.SaveEventToStream(@event, metaDataObj, environment + @event.CashSaleModel.CompanyId + "-CashSale", typeof(CashSaleUpdated).Name);
        }
    }
}
