...
namespace AppsWorld.JournalVoucherModule.Service
{
    ...
    {
        private readonly IJournalVoucherModuleRepositoryAsync<FinancialSetting> _financialSettingRepository;

        public FinancialSettingService(IJournalVoucherModuleRepositoryAsync<FinancialSetting> financialSettingRepository)
