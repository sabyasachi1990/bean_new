...
namespace AppsWorld.JournalVoucherModule.Service
{
    public class AccountTypeService : Service<AccountType>, IAccountTypeService
    {
        ...
        public AccountTypeService(IJournalVoucherModuleRepositoryAsync<AccountType> accountTypeService)
        ...
        //public List<AccountType> GetAllAccounyTypeByNameAccountType(long companyId, List<string> name)
        //{
