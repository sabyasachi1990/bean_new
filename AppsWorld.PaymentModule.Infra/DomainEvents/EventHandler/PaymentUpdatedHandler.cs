...
{
    public class PaymentUpdatedHandler:IDomainEventHandler<PaymentUpdated>
    {
        ...
        public void When(PaymentUpdated @event)
        {
            ...
            _eventStoreOperations.SaveEventToStream(@event, metaDataObj, environment + @event.PaymentModel.CompanyId + "-Payment", typeof(PaymentUpdated).Name);
        }
    }
}
